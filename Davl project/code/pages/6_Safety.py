...
with tab1:
    ...
    if chosen_id=="tab1":
        ...
        with open("car_rules.txt", "r") as f:
            text_content = f.read()
        st.text(text_content)
    elif chosen_id=="tab3":
        with open("bike_rules.txt", "r") as f:
            text_content = f.read()
        st.text(text_content)
    elif chosen_id=="tab4":
        with open("kid_rules.txt", "r") as f:
            text_content = f.read()
        st.text(text_content)
    elif chosen_id=="tab5":
        with open("road_issues.txt", "r") as f:
            text_content = f.read()
        st.text(text_content)
    elif chosen_id=="tab6":
        st.write(f"""
    ...
    """, unsafe_allow_html=True)
        with open("rules_everyone.txt", "r") as f:
            text_content = f.read()
        st.text(text_content)
