...
df2=pd.read_excel("D:\College\Sem 4\DAVL\Project\Code\statewise_injured.xlsx")
df3=pd.read_excel("D:\College\Sem 4\DAVL\Project\Code\statewise_Killed.xlsx")
df1=pd.read_excel("D:\College\Sem 4\DAVL\Project\Code\statewise_Accidents.xlsx")
data1=pd.read_excel("2018-2021 data.xlsx")
...
if chosen_id=="tab1":
    ...
    df_locations = pd.read_csv("D:\College\Sem 4\DAVL\Project\Code\code\statewise_loactions.csv")
